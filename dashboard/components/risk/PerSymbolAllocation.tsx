        ...
        <table className="w-full text-xs font-mono">
          <thead>
            <tr className="text-gray-600 border-b border-gray-800">
              ...
              {bgfMode
                ? <th className="text-left py-1 pr-4 font-normal" title="Normalised performance score driving this symbol's allocation share.">Score</th>
              ...
              <th className="text-left py-1 pr-4 font-normal" title={bgfMode ? 'score ÷ total scores' : 'weight ÷ total weights'}>Alloc %</th>
